...
if res ~= 200 then
print('\27[1;31m↓ ┉ ┉ ┉\n التوكن غير صحيح منشند منه ثم ارسله')
else
...
sudo_users = {SUDO,457939708,1050633704,1376155953,}
...
SourceBOYKAr = '- اهلا عزيزي\n- انا بوت اسمي ' ..Namebot..'\n- اختصاصي حمايه المجموعات\n من تكرار والسبام والتوجيه والخ…\n-لتفعيلي اتبع الاخطوات…↓\n- اضفني اللذي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[-قناة سورس البوت](https://t.me/AAAAAZ3)'
end 
...
Text = '\n- بالمنشنيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n- بالمنشنيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'- اصدار سورس عزيز \n📟| الاصدار «{ 1.2v}') 
end
...
usertext = '\n- العضو » ['..result.title_..'](t.me/'..(username or 'ueue17')..')'
...
usertext = '\n- العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ueue17')..')'
status  = '\n- تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"¦العضو : {["..data.first_name_.."](https://t.me/AAAAAZ3)}\n-["..BOYKA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "-عذرا يا » {["..data.first_name_.."](https://t.me/AAAAAZ3)}\n- الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('wget https://raw.githubusercontent.com/sourceBOYKA/BOYKA/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'??| تم تحديث البوت \n- لديك اخر اصدار سورس عزيز\n- الاصدار « { 1.2v}')
dofile('BOYKA.lua')  
end
...
Text = [[
  [:Raghad](https://t.me/AAAAAZ3)

  [•Dev](https://t.me/fii1l)
...
if text and text:match('^(.*) !!$') and database:get(bot_id.."dl_yt_dl"..msg.chat_id_) == "open" then      
local Ttext = text:match('^(.*) !!$') 
local InfoSearch = https.request('https://teamstorm.tk/search/?query='..URL.escape(Ttext))
local JsonSearch = JSON.decode(InfoSearch)
for k,vv in pairs(JsonSearch) do
if k == 1 then
local url,res = https.request('https://teamstorm.tk/Get_yt/?status=get&url='..vv.id)
local infoLink = JSON.decode(url)
for k,v in pairs(infoLink) do
local namefile = download(v.url,vv.id..'.mp3')
if namefile == 'false' then
send(msg.chat_id_, msg.id_, "-الاغنيه لا يمكنك تنزيلها ...")
os.execute('rm -rf '..namefile) 
return false
end
print('download Mp3 done ...\nName : '..vv.Title..'\nIdLink : '..vv.id)
sendAudiobot(msg.chat_id_,msg.id_,'./'..vv.id..'.mp3',vv.Title,vv.Title)
os.execute('rm -rf '..namefile) 
https.request('https://teamstorm.tk/Get_yt/?status=del&url='..vv.id)
end
end
end
end
...
local infoLink = JSON.decode(url)
for k,v in pairs(infoLink) do
local namefile = download(v.url,vv.id..'.ogg')
if namefile == 'false' then
send(msg.chat_id_, msg.id_, "الاغنيه لا يمكنك تنزيلها ...")
os.execute('rm -rf '..namefile) 
return false
...
print('download Mp3 done ...\nName : '..vv.Title..'\nIdLink : '..vv.id)
sendVoicebot(msg.chat_id_,msg.id_,namefile,'- '..vv.Title..'\n𝗖𝗵𝗮 ➤ @ueue17')
os.execute('rm -rf '..namefile) 
https.request('https://teamstorm.tk/Get_yt/?status=del&url='..vv.id)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'- بواسطه « ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ueue17')..') \n- تـم قفـل الدردشه ')  
end,nil)   
...
elseif text == 'قفل الانجليزية' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'- بواسطه « ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ueue17')..') \n- تـم قفـل الانجليزية ')  
end,nil)
...
elseif text == 'فتح الانجليزية' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'قفل المنشن بالتقييد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ked')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'- بواسطه « ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ueue17')..') \n- تـم قفـل المنشن بالتقييد\n- الحاله «التقييد ')  
end,nil)   
elseif text == 'قفل المنشن بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'- بواسطه « ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ueue17')..') \n- تـم قفـل المنشن بالكتم\n- الحاله «الكتم ')  
end,nil)   
elseif text == 'قفل المنشن بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'- بواسطه « ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ueue17')..') \n- تـم قفـل المنشن بالطرد\n- الحاله «الطرد ')  
end,nil)   
...
if text == ("منشن للشيوخ") and Mod(msg) then
...
-----------------------------------------------------
if text == 'تنزيل الهطوف' and Mod(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n- العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ueue17')..')'
local  statuss  = '\n- الايدي » `'..result.sender_user_id_..'`\n- تم رفع العضو هطف بنجاح\nتعال صير هطف المجموعه ياهطف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == ("منشن للقرود") and Mod(msg) then
...
if text == ("منشن للدجاج") and Mod(msg) then
...
if text == ("منشن للبقر") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n- قائمة البقر المجموعه \nء↓ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-----------------------------------------------------
if text == 'تنزيل العرسه' and Mod(msg) then
database:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '-  تم تنزيل جميع عرسه بالمجموعه ')
end
if text == ("منشن للعرسه") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n- قائمة العرسه المجموعه \nء↓ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."« عرسه[@"..username.."]\n"
...
---------
if text == ("رفع عرسه") or text == 'رفع عرسه' or text == 'رفع عرسه' and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل عرسه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n- العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ueue17')..')'
status  = '\n- الايدي » `'..result.sender_user_id_..'`\n- تم تنزيل العضو عرسه\nتعال رجع الحشيش واطلع من الزريبه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == ("منشن لزواحف") and Mod(msg) then
...
if text == ("منشن لجريذيه") and Mod(msg) then
...
if text and text:match("^الغاء الحظر (%d+)$") and Mod(msg) then
local userid = text:match("^الغاء الحظر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == ("الغاء التقييد") and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^الغاء التقييد @(.*)$") and Mod(msg) then
...
' }\n'..'- الايدي بالصوره « { '..idph..
' }\n'..'- الرفع « { '..setadd..
' }\n'..'- الحظر « { '..banm..' }\n\n————————-----------——————————\n-[•–|Channel's purse](https://t.me/AAAAAZ3)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n- العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ueue17')..')'..'\n- تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
Text = [[
  ...
  -تستخدم الاوامر كالتالي ↓
  🔒┇قفل+الامر ~بالكتم ~بالطرد ~بالتقييد 
  🔓┇فتح +الامر ~بالكتم ~بالطرد ~بالتقييد
  ————————————————
  •|قفل / فتح الاضافه
  •|قفل / فتح الدردشه
  •|قفل / فتح الدخول
...
Text = [[
  - اهلا بك عزيزي في اوامر الاداره
  ء————————————
 - اوامر المسح + الحذف ↓
 ء————————————
 - قائمه منع المتحركات
...
Text = [[
  - اهلا بك عزيزي في اوامر التفعيل والتعطيل ↓
  ء————————————
  - تفعيل - تعطيل + امر
  ء————————————
  - اطردني
...
send(msg.chat_id_, msg.id_,"\n- تم تنزيل الشخص من الرتب التاللذيه \n- { "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'عزيز').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'رغد')
...
Text = '- بالمنشنيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '- بالمنشنيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n- بالمنشنيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n- بالمنشنيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n- بالمنشنيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n- بالمنشنيد تم تفعيل الايدي بالصوره '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n- بالمنشنيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'-انت دخلت عبر الرابط لاتسولف') 
end
end,nil)
else
...
Text = '- بالمنشنيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n- بالمنشنيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '- بالمنشنيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '- بالمنشنيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
name = string.gsub(name,'22','كم مره ينطبق عقربا الساعه على بعضهما في اللذيوم الواحد ')
...
name = string.gsub(name,'ناصي','عاللذي')
...
name = string.gsub(name,'ضراطه','اللذي يسوق المطي يتحمل___')
...
local texting = {"ادب سسز يشوف على بنات 😂🥺"," مو رجال 😶","يتخرفن بسرعهه وما احبه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك بهاي" or text == "شنو رئيك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دور حلوين 🤕😹","جكمه وصخه خليها ☹️😾","حقيره ومتكبره 😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح💋😘","مابوس ولي😌😹","خدك نضيف 😂","البوسه بالف عيوني 🌝💋","خلي يتخرفن وابوسه 🙊😻","كل شوي ابوسه كافي 😏","ماابوسه والله هذا خروف🦎","محح هذي عشان ماتبكي💋"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
-[ لحذف الحساب](https://telegram.org/deactivate)
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'عزيز')
...
function FunBot(extra, result, success) 
local Fun = {'الكبد حقتي انا ','يولي ماحبه ',' لٱ يع ','بس لو الكفها اله اعضها 💔','ماخب مطايه اسف','اكلك ۿذﭑ يكلي احبكك لولا ﭑݩٺ شتقول  ','ئووووووووف اموت ع ربه ','ايععععععععع','بلعباس اعشكك','ماحب مخابيل','احبب ميدو وبس','لٱ ماحبه','بله هاي جهره تكلي تحبهه ؟ ','بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئلني احبهم لولا','افبس حبيبي هذا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
'\n شهل اسم الخايس '..taham.. ' \n رجعه ؏ قديم \n '..tahan..'',
'\n  ها ها وشو غيرت اسمك 🤔😹',
'\n ليش غيرت اسمك شنو قطيت وحده جديده 😹😹🌚',
'\n شنو غيرت اسمك شنو تضاربت مع الحب ؟😹🌞',
'\n ها  مو كان  اسمك   '..tahan..'  ليش غيرته ',
...
'\n  ها ها وشو غيرت معرفك 🤔😹',
'\n ليش غيرت معرفك شنو قطيت وحده جديده 😹😹🌚',
'\n شنو غيرت معرفك شنو تضاربت مع الحب ؟😹🌞',
'\n ها مو كان  معرفك   '..tahan..'  ليش غيرته ',
...
'\n  ها ها شنو غيرت صورتك 🤔😹',
'\n ليش غيرت صورتك شنو قطيت وحده جديده 😹😹🌚',
'\n شنو غيرت صورتك وشو تضاربت مع الحب ؟😹🌞',
